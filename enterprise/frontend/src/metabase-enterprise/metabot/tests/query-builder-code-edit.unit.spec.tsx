...
import { useMetabotSQLSuggestion as useMetabotSQLSuggestionEE } from "metabase-enterprise/metabot/hooks";
...
describe("query builder code edits from omnibot", () => {
  ...
  it("updates the proposed SQL in query builder when omnibot streams a code_edit", async () => {
    ...
    const conversationId =
      metabotStore.getState().plugins.metabotPlugin.conversations.omnibot
        ?.conversationId;
